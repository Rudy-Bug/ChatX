...
import 'package:chatting/presentation/modules/chatScreen/screen/chatScreen.dart';
// import 'package:chatting/presentation/modules/homeScreen/screen/homeScreen.dart';
import 'package:chatting/presentation/modules/homeScreen/screen/homeScreenVer02.dart';
...
abstract class  AppPages{
    static final List<GetPage> pages =  [
       ...
       GetPage(page: () =>  ChatScreen(), name: Routes.chatScreen  ) , 
      //  GetPage(page: () => const LoginScreen(), name: Routes.login  ) , 
    ] ;  
}
